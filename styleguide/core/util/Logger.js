export const LOG_VARNAME = 'bsp-logger-level'
...
export default class Logger {
  ...
  static welcomeMessage () {
    ...
    let title = `${colorMarker}Welcome to ${colorMarker}Brightsp${colorMarker}o${colorMarker}t${colorMarker} Express${colorMarker}!`
    let body = `${colorMarker}To enable verbose logging from Brightspot Express Javascript plugins, set the session storage variable ${colorMarker}bsp-logger-level ${colorMarker}to 1`
