 ...
 * {@link TabsModulePlacementInline} and {@link TabsModulePlacementShared}.
 */
public class TabsModulePlacementInlineSubstitution extends TabsModulePlacementInline implements
        Copyable,
        Interchangeable,
        Substitution {
    ...
    public void onCopy(Object source) {
        if (source instanceof TabsModulePlacementShared) {
    ...
    public boolean loadTo(Object target) {
        ...
        if (target instanceof TabsModulePlacementShared) {
            ...
            TabsModule sharedModule = Copyable.copy(ObjectType.getInstance(TabsModule.class), this);
            ...
            TabsModulePlacementShared sharedPlacement = ((TabsModulePlacementShared) target);
