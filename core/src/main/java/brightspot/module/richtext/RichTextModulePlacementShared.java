...
@Recordable.DisplayName("Shared Rich Text Module")
@Recordable.Embedded
@Deprecated
public class RichTextModulePlacementShared extends Record implements
    ModelWrapper,
    ModularSearchIndexFields,
    ModulePlacement {

    private RichTextModule shared;

    public RichTextModule getShared() {
        return shared;
    }

    public void setShared(RichTextModule shared) {
        this.shared = shared;
    }
