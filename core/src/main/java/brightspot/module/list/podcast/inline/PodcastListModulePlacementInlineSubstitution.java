...
import brightspot.module.list.podcast.shared.PodcastListModule;
 ...
 * {@link PodcastListModulePlacementInline} and {@link PodcastListModulePlacementShared}.
 */
public class PodcastListModulePlacementInlineSubstitution extends PodcastListModulePlacementInline implements
        Copyable,
        Interchangeable,
        Substitution {
    ...
    public void onCopy(Object source) {
        if (source instanceof PodcastListModulePlacementShared) {
    ...
    public boolean loadTo(Object target) {
        ...
        if (target instanceof PodcastListModulePlacementShared) {
            ...
            PodcastListModule sharedModule = Copyable.copy(ObjectType.getInstance(PodcastListModule.class), this);
            ...
            PodcastListModulePlacementShared sharedPlacement = ((PodcastListModulePlacementShared) target);
