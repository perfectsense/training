 ...
 * {@link AuthorListModulePlacementInline} and {@link AuthorListModulePlacementShared}.
 */
public class AuthorListModulePlacementInlineSubstitution extends AuthorListModulePlacementInline implements
        Copyable,
        Interchangeable,
        Substitution {
    ...
    public void onCopy(Object source) {
        if (source instanceof AuthorListModulePlacementShared) {
    ...
    public boolean loadTo(Object target) {
        ...
        if (target instanceof AuthorListModulePlacementShared) {
            ...
            AuthorListModule sharedModule = Copyable.copy(ObjectType.getInstance(AuthorListModule.class), this);
            ...
            AuthorListModulePlacementShared sharedPlacement = ((AuthorListModulePlacementShared) target);
