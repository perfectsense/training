 ...
 * {@link LogoImageListModulePlacementShared} and {@link LogoImageListModulePlacementInline}.
 */
public class LogoImageListModulePlacementSharedSubstitution extends LogoImageListModulePlacementShared implements
        Interchangeable,
        Substitution {
    ...
    public boolean loadTo(Object target) {
        ...
        if (target instanceof LogoImageListModulePlacementInline) {

            LogoImageListModule sharedModule = getShared();
    ...
    public List<UUID> loadableTypes(Recordable recordable) {
        ...
        return ImmutableList.of(
                ObjectType.getInstance(LogoImageListModulePlacementInline.class).getId()
        );
    }
}
