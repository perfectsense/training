 ...
 * {@link StatListModulePlacementInline} and {@link StatListModulePlacementShared}.
 */
public class StatListModulePlacementInlineSubstitution extends StatListModulePlacementInline implements
        Copyable,
        Interchangeable,
        Substitution {
    ...
    public void onCopy(Object source) {
        if (source instanceof StatListModulePlacementShared) {
    ...
    public boolean loadTo(Object target) {
        ...
        if (target instanceof StatListModulePlacementShared) {
            ...
            StatListModule sharedModule = Copyable.copy(ObjectType.getInstance(StatListModule.class), this);
            ...
            StatListModulePlacementShared sharedPlacement = ((StatListModulePlacementShared) target);
