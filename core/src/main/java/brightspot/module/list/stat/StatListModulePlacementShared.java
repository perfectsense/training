...
@Recordable.DisplayName("Shared Stat List Module")
@Recordable.Embedded
@Deprecated
public class StatListModulePlacementShared extends Record implements
    ModelWrapper,
    ModularSearchIndexFields,
    ModulePlacement {

    private StatListModule shared;

    public StatListModule getShared() {
        return shared;
    }

    public void setShared(StatListModule shared) {
        this.shared = shared;
    }
