 ...
 * {@link PersonListModulePlacementInline} and {@link PersonListModulePlacementShared}.
 */
public class PersonListModulePlacementInlineSubstitution extends PersonListModulePlacementInline implements
        Copyable,
        Interchangeable,
        Substitution {
    ...
    public void onCopy(Object source) {
        if (source instanceof PersonListModulePlacementShared) {
    ...
    public boolean loadTo(Object target) {
        ...
        if (target instanceof PersonListModulePlacementShared) {
            ...
            PersonListModule sharedModule = Copyable.copy(ObjectType.getInstance(PersonListModule.class), this);
            ...
            PersonListModulePlacementShared sharedPlacement = ((PersonListModulePlacementShared) target);
