 ...
 * {@link PersonListModulePlacementShared} and {@link PersonListModulePlacementInline}.
 */
public class PersonListModulePlacementSharedSubstitution extends PersonListModulePlacementShared implements
        Interchangeable,
        Substitution {
    ...
    public boolean loadTo(Object target) {
        ...
        if (target instanceof PersonListModulePlacementInline) {

            PersonListModule sharedModule = getShared();
    ...
    public List<UUID> loadableTypes(Recordable recordable) {
        ...
        return ImmutableList.of(
                ObjectType.getInstance(PersonListModulePlacementInline.class).getId()
        );
    }
}
