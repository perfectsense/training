...
/**
 * The purpose of this class is to provide drag and drop support for {@link ThreeColumnContainerModule}
 * from the CMS UI Shelf into {@link ContainerModulePlacementShared}.
 */
public class ThreeColumnContainerModuleSubstitution extends ThreeColumnContainerModule implements
        Interchangeable,
        Substitution {
