...
/**
 * The purpose of this class is to provide drag and drop support for {@link OneColumnContainerModule}
 * from the CMS UI Shelf into {@link ContainerModulePlacementShared}.
 */
public class OneColumnContainerModuleSubstitution extends OneColumnContainerModule implements
        Interchangeable,
        Substitution {
