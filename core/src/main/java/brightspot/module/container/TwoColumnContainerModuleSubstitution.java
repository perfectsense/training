...
/**
 * The purpose of this class is to provide drag and drop support for {@link TwoColumnContainerModule}
 * from the CMS UI Shelf into {@link ContainerModulePlacementShared}.
 */
public class TwoColumnContainerModuleSubstitution extends TwoColumnContainerModule implements
        Interchangeable,
        Substitution {
