...
@Recordable.DisplayName("Shared Promo Module")
@Recordable.Embedded
@Deprecated
public class PagePromoModulePlacementShared extends Record implements
    ModelWrapper,
    ModularSearchIndexFields,
    ModulePlacement {

    private PagePromoModule shared;

    public PagePromoModule getShared() {
        return shared;
    }

    public void setShared(PagePromoModule shared) {
        this.shared = shared;
    }
