...
@JsonLdType("WebPage")
public class PersonAuthorPageViewModel extends AbstractContentPageViewModel<PersonAuthor>
    implements AuthorPageView, PageEntryView {
    ...
    public Iterable<? extends AuthorPageViewShortBiographyField> getShortBiography() {
        return RichTextUtils.buildHtml(
            model,
            PersonAuthor::getShortBiography,
            e -> createView(AuthorPageViewShortBiographyField.class, e));
    }
